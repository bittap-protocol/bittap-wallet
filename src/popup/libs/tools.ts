...
export const netWorkTypes = ['mainnet', 'regtest', 'testnet']
...
export const TestNetUrl = 'https://signet.bittap.org'
...
export const BROADCAST_ON_LISTEN_TRANSACTION_EVENT =
    'broadcast-Bittap-onListenTransaction'
...
export const networkRpcTokenExpiredTime = useStorage(
    'networkRpcTokenExpiredTime',
    -1
)
